 ...
 * generated in the com.ljw.webservice_jdk package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherResponse_QNAME = new QName("http://webservice_jdk.ljw.com", "getWeatherResponse");
    private final static QName _GetWeather_QNAME = new QName("http://webservice_jdk.ljw.com", "getWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ljw.webservice_jdk
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice_jdk.ljw.com", name = "getWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice_jdk.ljw.com", name = "getWeather")
